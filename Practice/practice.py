...
# print("ჩემი სახელია" + " " + name + ", " + "ჩემი გვარია" + " " + last_name + ", " + "მე ვსწავლობ" + " " + school + "ში, " + "მე ვარ" + " " + str(klasi) + " " + "კლასში, "  + "სიმაღლეში ვარ" + " " + str(height) + ", " + "ჩემი საყვარელი საჭმელია" + " " + favyy + "." ) 

# num1 = 5134
# num2 = 1724
# population = 17323

# print(population + num1 - num2)
# print(num1 + num2 * population)
# print(population * num2 / num1)
# print(num1 ** 2 / num2)

# name, age, height, last_name = "giorgi", 16, 1.70, "tlashadze"
...
# print(song.capitalize()) - პირველი სიტყვის პირველი ასოს Capital-ად გადაქევა
